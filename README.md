...
- ### [2021 Sep](https://research.checkpoint.com/2021/mosesstaff-targeting-israeli-companies/)
  > The Iranian linked group **MosesStaff** carried out targeted attacks against Israeli companies mainly to cause damage by leaking sensitive information and destroying data.
...
- ### [2021 Sep - 2022 Jun](https://www.welivesecurity.com/en/eset-research/sponsor-batch-filed-whiskers-ballistic-bobcats-scan-strike-backdoor/)
  > The Iranian hackers groups **Ballistic Bobcat** (APT35) hacked various Israeli companies in multiple industries like automotive, communication, finance and many more, using the Sponsor backdoor.
...
- ### [2022 Feb](https://research.checkpoint.com/2022/check-point-research-exposes-an-iranian-phishing-campaign-targeting-former-israeli-foreign-minister-former-us-ambassador-idf-general-and-defense-industry-executives/)
  > Unknown Iranian hackers used spear-phishing attacks against high ranking Israeli officials. The attackers used sophisticated techniques likes hijacking email conversation threads after hacking one of correspondents.

- ### [2023 Feb](https://blogs.blackberry.com/en/2023/02/darkbit-ransomware-targets-israel)
  > The Iranian group **MuddyWater** used a Cyber Persona and data Wiper/Ransomware named DarkBit, to attack the Israeli Technion University, but without actually offering to recover the data.

- ### [2023 Sep. 21](https://www.welivesecurity.com/en/eset-research/oilrigs-outer-space-juicy-mix-same-ol-rig-new-drill-pipes/)
  > The Iranian APT group **OilRig** (aka APT34, etc) operated two cyber espionage campaigns.\
	Outer Space (2021) and Juicy Mix (2022) against Israeli organizations.
...
- ### [2023 Oct. 19](https://symantec-enterprise-blogs.security.com/blogs/threat-intelligence/crambus-middle-east-government) 
  > The Iranian **OilRig** cyber espionage group (aka APT34, etc) broke into computer networks in an unspecified country in the middle east and collected data for 8 months.
...
- [MuddyWater](https://attack.mitre.org/groups/G0069/) (aka Static Kitten, Mango Sandstorm, Mercury, ...)
  `Espionage and Sabotage`
