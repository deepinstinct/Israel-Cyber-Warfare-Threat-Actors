...
- ### [2020 April. 24 - 25](https://www.timesofisrael.com/6-facilities-said-hit-in-irans-cyberattack-on-israels-water-system-in-april/)
  ...
  According to [Western Officials](https://www.timesofisrael.com/iran-cyberattack-on-israels-water-supply-could-have-sickened-hundreds-report/), the hack aimed to raise Chlorin levels, a scenario that could've caused wide-scale water poisoning.
...
- ### [2021 Sep - 2022 Jun](https://www.welivesecurity.com/en/eset-research/sponsor-batch-filed-whiskers-ballistic-bobcats-scan-strike-backdoor/)
...
- ### [2022 Feb](https://research.checkpoint.com/2022/check-point-research-exposes-an-iranian-phishing-campaign-targeting-former-israeli-foreign-minister-former-us-ambassador-idf-general-and-defense-industry-executives/)
  > Unknown Iranian hackers used spear-phishing attacks against high ranking Israeli officials. 
  The attackers were able to gain credibility by infiltrating into email conversation threads after hacking one of the correspondents.

- ### [2023 Feb](https://blogs.blackberry.com/en/2023/02/darkbit-ransomware-targets-israel)
  > The Iranian group **MuddyWater** are suspected to be behind the DarkBit Ransomware/Wiper Attacks on the Israeli Technion University.
  The attackers promoted anti-Israeli rhetoric, protested tech layoffs and demanded 80 BTC (at that time around $1.7 million) as ransom.
...
Afkar Systems, Najee Technologies (Nemesis Kitten/APT35 Cluster), and more.\
Some of the prominent targets are Israel, the United States, Gulf states like the United Arab Emirates, 
Bahrain, Saudi Arabia, and Iranian political adversaries.

Iranian cyber operations vary from Ransomware, Defacement, Sabotage (DOS/Wipers), espionage, theft and gaining illicit profit, 
to manipulation and influence campaigns, aka Cyber-Enabled Influence Operations (IOs). 

The influence campaigns include themes like Palestinian resistance, Shi'ite unrest in the Gulf, counter-Arab-Israeli normalization and economic relations, 
...
### **IRGC** (Islamic Revolutionary Guard Corps)
- [Cotton Sandstorm](https://industrialcyber.co/ransomware/microsoft-detects-iran-turning-to-cyber-enabled-influence-operations-for-greater-effect/) (aka Neptunium, Emennet Pasargad, ViceLeaker)\
  `Sabotage and Influence Ops`
- [Fox Kitten](https://attack.mitre.org/groups/G0117/)(aka Pioneer Kitten)\
  `Espionage and Profit`
- [APT 33](https://attack.mitre.org/groups/G0064/) (aka Holmium)\
  `Espionage and Sabotage`
- [APT 42](https://www.mandiant.com/resources/blog/apt42-charms-cons-compromises)\
  `Espionage`
- [APT 35](https://attack.mitre.org/groups/G0059/) (Cluster)\
  ...
  - **Subgroups** 
    ...
    - Magic Hound
    - Ballistic Bobcat 
  - [Nemesis Kitten](https://apt.etda.or.th/cgi-bin/showcard.cgi?g=Subgroup%3A%20DEV%2D0270%2C%20Nemesis%20Kitten) (Cobalt Mirage/Illusion) \
  `Espionage and Profit`
- [Imperial Kitten](https://malpedia.caad.fkie.fraunhofer.de/actor/tortoiseshell) (aka TortoiseShell)\
  `Espionage`
- Cobalt Sapling \
 `Sabotage and Espionage`
  - [MosesStaff](https://attack.mitre.org/groups/G1009/) (aka Marigold Sandstorm)
    ...
    - [Linked](https://www.secureworks.com/blog/abrahams-ax-likely-linked-to-moses-staff) to **Abrahams Ax** 

### **MOIS** (Ministry of Intelligence and Security) 
> *Aka VEVAK (in Farsi) previously SAVAK*
- [MuddyWater](https://attack.mitre.org/groups/G0069/) (aka Static Kitten, Mango Sandstorm, Mercury, and more) \
  `Espionage and Sabotage`
  - Also behind the the Cyber Persona/Ransomware named DarkBit
- [OilRig](https://attack.mitre.org/groups/G0049/) (aka APT34, Lyceum, Crambus, HelixKitten, ...)\
  `Influence Ops, Sabotage and Espionage`
- SiameseKitten (aka Hexane/Lyceum) 
  - Operation activity swapped with OilRig after the "Dookhtegan" [leaks](https://www.wired.com/story/iran-hackers-oilrig-read-my-lips/).
- [Agrius](https://www.sentinelone.com/labs/from-wiper-to-ransomware-the-evolution-of-agrius/)
  - Used the Cyber Persona BlackShadow

### Unknown Governmental Agency
- [Domestic Kitten](https://malpedia.caad.fkie.fraunhofer.de/actor/domestic_kitten) (APT-C-50)

### Hacktivists
- [SiegedSec](https://socradar.io/threat-actor-profile-siegedsec/)
- [Abraham's Ax](https://www.watchguard.com/wgrd-security-hub/ransomware-tracker/abrahams-ax)
...
- [FurBall](https://www.eset.com/int/about/newsroom/press-releases/research/masquerading-as-a-translation-app-furball-spyware-goes-after-iranian-citizens-eset-research-finds/) (Android, **Domestic Kitten**)
  ...
  ```
- [TelegramGrabber](https://www.pwc.com/gx/en/issues/cybersecurity/cyber-threat-intelligence/old-cat-new-tricks.html) (Win64 EXE, **Yellow Garuda**)
  ```
  1310245dd050596a03f63b604417172cabeb8fb1
  ```
- [PineFlower] (Android)
- [SyncroRAT] (**MuddyWater**)
- [DarkBit Ransomware](https://www.gov.il/BlobFolder/news/_muddywater/en/government%20threat%20actor.pdf) (Win32 EXE, **MuddyWater**)
   ```
   30466ccd4ec7bcafb370510855da2cd631f74b7a
   ```
- PoisonFrog and Glimpse (BondUpdater Trojan)
- [Sponsor Backdoor](https://www.welivesecurity.com/en/eset-research/sponsor-batch-filed-whiskers-ballistic-bobcats-scan-strike-backdoor/) (Win32 EXE, **Ballistic Bobcat**)
  ```
...
- [Helminth Trojan](https://blog.morphisec.com/iranian-fileless-cyberattack-on-israel-word-vulnerability)
- [ViceLeaker](https://securelist.com/fanning-the-flames-viceleaker-operation/90877/) (Apk, Aka [Triout  Spyware](https://www.bitdefender.com/blog/labs/triout-spyware-framework-for-android-with-extensive-surveillance-capabilities/), **Neptunium**)
  ```
  Samples:
  ...
  ```
- [Moneybird](https://research.checkpoint.com/2023/agrius-deploys-moneybird-in-targeted-attacks-against-israeli-organizations/) (**Agrius**)
- [Apostle Wiper](https://www.sentinelone.com/labs/from-wiper-to-ransomware-the-evolution-of-agrius/) (**Agrius**)
- [DEADWOOD Wiper](https://www.sentinelone.com/labs/from-wiper-to-ransomware-the-evolution-of-agrius/)
- [Apostle Ransomware](https://www.sentinelone.com/labs/new-version-of-apostle-ransomware-reemerges-in-targeted-attack-on-higher-education/) (aka Detbosit, **Agrius**)
